  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="menuPrincipal">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link text-white" href="inicial.php">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="pagina_clientes.php">Clientes</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="visualizacao_tickts.php">Tickets</a>
        </li>
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="configDropdown">
            ...
            <li class="dropdown-submenu">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="#" onclick="event.preventDefault(); setTema('escuro')">Escuro</a>
                </li>
              </ul>
            </li>
            ...
            <li class="dropdown-submenu">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="#">Gerenciar Permissões</a></li>
              </ul>
            </li>
          </ul>
        </li>
