...
<body>
    ...
    include_once "../classes/clientes_cadastrados.php";
        ...
        <div class="container mt-5">
            <div class="principal shadow p-4 rounded-3 text-light">
                ...
                <form action="#" method="post">
                    ...
                    <button type="submit" class="btn btn-success w-100 mb-2">Salvar Ticket</button>
                    <a href="visualizacao_tickts.php" class="btn btn-secondary w-100">Cancelar</a>
                </form>
